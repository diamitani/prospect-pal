...
const PLANS = [
  {
    ...
    badge: "DIY",
    description: "Everything you need to build your own SDR automation. Agent skills, workflow templates, prompts, and documentation.",
    features: [
  ...
  },
  {
    ...
    badge: "Most Popular",
    description: "Design custom campaigns with our AI architect. Generate workflows for n8n, Make, or Gumloop based on your inputs.",
    features: [
      "Unlimited Campaign Compiles",
      "Agent Chat Interface",
      "Live Workflow Canvas",
      "Multi-Platform Export (n8n, Make, Gumloop)",
      "A/B Email Copy Studio",
      "Deploy Direct to Your Instance",
    ],
    highlight: true,
    cta: "Start Building ($99/mo)",
  },
  {
    id: "core",
    name: "Core SDR Agent",
    price: "$199",
    billing: "per month, full automation",
    badge: "Full Stack",
    description: "Skip the workflow platforms entirely. Our agent handles prospect research, outreach, and reporting directly from the dashboard.",
    features: [
