      ...
      >
        <div style={{ maxWidth: "var(--layout-max)", margin: "0 auto" }}>
          <SectionHeading
            ...
            title="How we build your workflow"
            description="Every campaign follows our 9-stage development cycle. Systematic quality at every step."
          />
          <div
            style={{
              display: "grid",
            ...
            {[
              {
                stage: "01",
                title: "Intake",
                description: "Capture your ICP, persona, tools, and campaign goals",
                color: "var(--cobalt-500)",
              },
              {
                stage: "02",
                title: "Documentation",
                description: "Document your stack, messaging, and success criteria",
                color: "var(--cobalt-500)",
              },
              {
                stage: "03",
                title: "Scaffolding",
                description: "Structure the 9-node workflow architecture",
                color: "var(--champagne-500)",
              },
              {
                stage: "04",
                title: "Scripts",
                description: "Configure each node with your specific logic",
                color: "var(--champagne-500)",
              },
              {
                stage: "05",
                title: "Connecting",
                description: "Wire your CRM, data tools, and outreach platforms",
                color: "var(--signal-info)",
              },
              {
                stage: "06",
                title: "Deploying",
                description: "Push to your n8n instance or export the JSON",
                color: "var(--signal-info)",
              },
              {
                stage: "07",
                title: "Testing",
                description: "Run test prospects through the complete flow",
                color: "#10B981",
              },
              {
                stage: "08",
                title: "Refining",
                description: "Optimize based on results and reply rates",
                color: "#10B981",
              },
              {
                stage: "09",
                title: "Maintaining",
                description: "Ongoing support for changes and iterations",
                color: "#10B981",
              },
            ].map((item) => (
              <div
